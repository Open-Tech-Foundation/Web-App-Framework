...
| Prompt | Options |
| --- | --- |
| **Project type** | **SPA (browser-only)** · **Fullstack (browser + server)** · **Documentation site** · **Library** — see [Installation](/docs/getting-started/installation#choosing-a-project-type) |
...
<Callout type="info" title="Next steps">
  SPA, Fullstack, and Docs projects suggest `bun run dev` (or the equivalent for your
  package manager). Library projects suggest `bun test` — see
