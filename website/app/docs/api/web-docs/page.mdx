...
| `@opentf/web-docs/nav` | Generated sidebar tree (resolved by `docsNavPlugin`). |
...
| Field | Type | Notes |
| --- | --- | --- |
| `site.url` | string | Canonical origin — canonicals, sitemap, RSS. |
...
| Export | Purpose |
| --- | --- |
| `docsNavPlugin` | Resolves `@opentf/web-docs/nav` to the sidebar tree. |
